        ...
        <div className="container mx-auto px-4 max-w-7xl">
           <div className="relative bg-primary rounded-[56px] p-12 md:p-24 overflow-hidden flex flex-col items-center text-center gap-10 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-8 w-full max-w-xl relative z-10 mt-6">
                 ...
                 <a href="tel:+966 51 094 2150" className="flex-1 px-12 py-6 bg-white text-primary rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-4 shadow-xl hover:bg-secondary hover:text-white transition-all active:scale-95 border-b-4 border-slate-100">Call Now</a>
              </div>
           </div>
        </div>
      </section>
